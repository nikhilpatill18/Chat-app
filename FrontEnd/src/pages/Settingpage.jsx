        ...
        <div className='h-full container mx-auto px-4 pt-20 max-w-5xl '>
            <div className='space-y-6'>
                <div className='flex flex-col gap-1'>
                    ...
                    <p className='text-sm text-base-content/70'>Choose the theme for the chat application</p>
                </div>
                <div className='grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-2'>
                    {THEMES.map((t) => (
                        <button key={t} className={`group flex flex-col items-center gap-1.5 p-2 rounded-lg transition-colors ${theme == t ? "bg-base-100" : "hover:bg-base-100/50"}`} onClick={() => setTheme(t)} >
                    ...
                    <div className="p-4 bg-base-200">
                        <div className="max-w-lg mx-auto">
                            ...
                            <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                                ...
                                {/* messsage componensts */}

                                <div className='min-h-[200px] max-h-[200px] overflow-y-auto bg-base-100 p-4 space-y-4'>
                                    {
                                        demo_message.map((message) => (
